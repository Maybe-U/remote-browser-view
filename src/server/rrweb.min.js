var rrweb = function(ee) {
    ...
    var qe = function() {
        ...
        t.prototype.removeNodeFromMap = function(e) {
            ...
            e.childNodes && e.childNodes.forEach(function(o) {
    ...
    function et(t) {
        var e = t.maskInputOptions
          ...
          , a = t.maskInputFn
          , s = o || "";
        return (e[n.toLowerCase()] || e[r]) && (a ? s = a(s) : s = "*".repeat(s.length)),
        s
    }
    ...
    function Ve(t, e) {
        return (t || "").replace(or, function(n, r, o, a, s, i) {
            ...
            if (l[0] === "/")
                return "url(".concat(c).concat(rr(e) + l).concat(c, ")");
            var u = e.split("/")
              , d = l.split("/");
            u.pop();
    ...
    function cr(t, e) {
        ...
        !(n >= e.length); ) {
            var a = r(ar);
            if (a.slice(-1) === ",")
                a = Be(t, a.substring(0, a.length - 1)),
                o.push(a);
            else {
                var s = "";
                a = Be(t, a);
    ...
    function gr(t, e) {
        ...
        if (y === "option" && (t.selected && !i.select ? g.selected = !0 : delete g.selected),
        y === "canvas" && h) {
            if (t.__context === "2d")
        ...
        if ((y === "audio" || y === "video") && (g.rr_mediaState = t.paused ? "paused" : "played",
        g.rr_mediaCurrentTime = t.currentTime),
        b || (t.scrollLeft && (g.rr_scrollLeft = t.scrollLeft),
        ...
        return y === "iframe" && !p(g.src) && (t.contentDocument || (g.rr_src = g.src),
        delete g.src),
        {
            type: D.Element,
            tagName: y,
    ...
    function Ee(t, e) {
        ...
        if ((T.type === D.Document || T.type === D.Element) && W) {
            ...
            if (Tt(t) && t.shadowRoot)
                for (var ue = 0, A = Array.from(t.shadowRoot.childNodes); ue < A.length; ue++) {
                    var ae = A[ue]
                      , B = Ee(ae, xe);
                    B && (Le(t.shadowRoot) && (B.isShadow = !0),
                    T.childNodes.push(B))
                }
        }
        return t.parentNode && Oe(t.parentNode) && Le(t.parentNode) && (T.isShadow = !0),
        T.type === D.Element && T.tagName === "iframe" && hr(t, function() {
        ...
        T.type === D.Element && T.tagName === "link" && T.attributes.rel === "stylesheet" && pr(t, function() {
            if (q) {
                var ie = Ee(t, {
                    doc: n,
                    mirror: r,
...
`);
        ...
        function h() {
            var w, v = [];
            for (m(),
            b(v); t.length && t.charAt(0) !== "}" && (w = L() || te()); )
                w !== !1 && (v.push(w),
                b(v));
            return v
        }
        ...
        function E() {
            for (var w, v = [], M = a(); w = p(/^((\d+\.\d+|\.\d+|\d+)%?|[a-z]+)\s*/); )
                v.push(w[1]),
                p(/^,\s*/);
            if (v.length)
                return M({
    ...
    function wr(t) {
        ...
        return e === "link" && t.attributes._cssText && (e = "style"),
        e
    }
    function Er(t) {
        return t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")
    ...
    function Pt(t, e) {
        ...
        return e?.stylesWithHoverClass.set(t, s),
        s
    }
    function Wt() {
        var t = new Map;
                ...
                for (var l in t.attributes)
                    if (Object.prototype.hasOwnProperty.call(t.attributes, l)) {
                        ...
                        if (!(a === "option" && l === "selected" && c === !1)) {
                            ...
                            if (d && r && typeof c == "string" && (c = Pt(c, o)),
                            (u || d) && typeof c == "string") {
                            ...
                            try {
                                if (t.isSVG && l === "xlink:href")
                                    s.setAttributeNS("http://www.w3.org/1999/xlink", l, c.toString());
                                    ...
                                    a === "link" && t.attributes.rel === "preload" && t.attributes.as === "script" || a === "link" && t.attributes.rel === "prefetch" && typeof t.attributes.href == "string" && t.attributes.href.endsWith(".js") || (a === "img" && t.attributes.srcset && t.attributes.rr_dataURL ? s.setAttribute("rrweb-original-srcset", t.attributes.srcset) : s.setAttribute(l, c.toString()))
                            } catch {}
                        }
                    }
                var S = function(y) {
                    ...
                    if (a === "canvas" && y === "rr_dataURL") {
                        ...
                        var k = s;
                        k.currentSrc.startsWith("data:") || (k.setAttribute("rrweb-original-src", t.attributes.src),
                        k.src = g.toString())
                    }
                    if (y === "rr_width")
                        s.style.width = g.toString();
                    else if (y === "rr_height")
                        s.style.height = g.toString();
    ...
    function _e(t, e) {
        ...
        if (!u)
            return null;
        if (t.rootId && r.getNode(t.rootId) !== n && r.replace(t.rootId, n),
        t.type === D.Document && (n.close(),
        n.open(),
        t.compatMode === "BackCompat" && t.childNodes && t.childNodes[0].type !== D.DocumentType && (t.childNodes[0].type === D.Element && "xmlns"in t.childNodes[0].attributes && t.childNodes[0].attributes.xmlns === "http://www.w3.org/1999/xhtml" ? n.write('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "">') : n.write('<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "">')),
        u = n),
        r.add(u, t),
        (t.type === D.Document || t.type === D.Element) && !a)
            for (var d = 0, h = t.childNodes; d < h.length; d++) {
                ...
                p.isShadow && Tt(u) && u.shadowRoot ? u.shadowRoot.appendChild(m) : u.appendChild(m),
                l && l(m, p.id)
            }
        return u
    }
...
or you can use record.mirror to access the mirror instance during recording.`;
    ...
    function Ce(t, e, n={}) {
        ...
        return function(...a) {
            ...
            const i = e - (s - o)
              , l = this;
            i <= 0 || i > e ? (r && (clearTimeout(r),
            r = null),
            o = s,
            t.apply(l, a)) : !r && n.trailing !== !1 && (r = setTimeout( () => {
    ...
    var kr = Object.freeze({
      ...
      , C = (t => (t[t.DomContentLoaded = 0] = "DomContentLoaded",
    t[t.Load = 1] = "Load",
    ...
    class Dr {
        ...
        addNode(e) {
            ...
            if (e.__ln = n,
            e.previousSibling && Bt(e.previousSibling)) {
        ...
        constructor() {
            ...
            this.emit = () => {
                ...
                const e = []
                  ...
                  , o = i => {
                    ...
                    let p = h;
                    for (; ((d = (u = p?.getRootNode) == null ? void 0 : u.call(p)) == null ? void 0 : d.nodeType) === Node.DOCUMENT_FRAGMENT_NODE && p.getRootNode().host; )
                    ...
                    const f = Ee(i, {
                        ...
                        onSerialize: y => {
                            ...
                            ct(y, this.mirror) && this.stylesheetManager.trackLinkElement(y),
                            ve(i) && this.shadowDomManager.addShadowRoot(i.shadowRoot, this.doc)
                        }
                        ,
                        onIframeLoad: (y, g) => {
                ...
                for (const i of Array.from(this.movedSet.values()))
                    jt(this.removes, i, this.mirror) && !this.movedSet.has(i.parentNode) || o(i);
                for (const i of Array.from(this.addedSet.values()))
                    !Ht(this.droppedSet, i) && !jt(this.removes, i, this.mirror) || Ht(this.movedSet, i) ? o(i) : this.droppedSet.add(i);
                let a = null;
                for (; n.length; ) {
                    let i = null;
                    if (a) {
                    ...
                    case "attributes":
                        {
                            ...
                            e.attributeName === "style") {
                                ...
                                o.attributes[e.attributeName] = Ot(this.doc, n.tagName, e.attributeName, r);
                            break
                        }
                    case "childList":
                        {
                            ...
                            e.removedNodes.forEach(n => {
                                ...
                                Q(e.target, this.blockClass, this.blockSelector, !1) || je(n, this.mirror) || !$t(n, this.mirror) || (this.addedSet.has(n) ? (pt(this.addedSet, n),
                                this.droppedSet.add(n)) : this.addedSet.has(e.target) && r === -1 || st(e.target, this.mirror) || (this.movedSet.has(n) && this.movedMap[Gt(r, o)] ? pt(this.movedSet, n) : this.removes.push({
                                    parentId: o,
                                    id: r,
            ...
            this.genAdds = (e, n) => {
                if (this.mirror.hasNode(e)) {
                    ...
                    r && r !== -1 && (this.movedMap[Gt(this.mirror.getId(e), r)] = !0)
                } else
                    this.addedSet.add(e),
    ...
    var xr = Object.defineProperty
      ...
      , Kt = (t, e) => {
        for (var n in e || (e = {}))
            Ar.call(e, n) && Zt(t, n, e[n]);
        if (Xt)
            for (var n of Xt(e))
                _r.call(e, n) && Zt(t, n, e[n]);
        return t
    }
      , Fr = (t, e) => Or(t, Lr(e));
    const Se = []
    ...
    function Vr({inputCb: t, doc: e, mirror: n, blockClass: r, blockSelector: o, ignoreClass: a, maskInputOptions: s, maskInputFn: i, sampling: l, userTriggeredOnInput: c}) {
        function u(S) {
            let f = Pe(S);
            const y = S.isTrusted;
            if (f && f.tagName === "OPTION" && (f = f.parentElement),
            !f || !f.tagName || Ur.indexOf(f.tagName) < 0 || Q(f, r, o, !0))
                return;
            const g = f.type;
            if (f.classList.contains(a))
                return;
            let E = f.value
              , k = !1;
    ...
    function Br({styleSheetRuleCb: t, mirror: e, stylesheetManager: n}, {win: r}) {
        ...
        let i;
        r.CSSStyleSheet.prototype.replaceSync && (i = r.CSSStyleSheet.prototype.replaceSync,
        ...
        const l = {};
        Qt ? l.CSSGroupingRule = r.CSSGroupingRule : (Jt && (l.CSSMediaRule = r.CSSMediaRule),
    ...
    function Yr(t, e) {
        ...
        t.mutationCb = (...m) => {
            e.mutation && e.mutation(...m),
            n(...m)
        }
        ,
        t.mousemoveCb = (...m) => {
            e.mousemove && e.mousemove(...m),
            r(...m)
        }
        ,
        t.mouseInteractionCb = (...m) => {
            e.mouseInteraction && e.mouseInteraction(...m),
            o(...m)
        }
        ,
        t.scrollCb = (...m) => {
        ...
        t.viewportResizeCb = (...m) => {
            e.viewportResize && e.viewportResize(...m),
            s(...m)
        }
        ,
        t.inputCb = (...m) => {
        ...
        t.mediaInteractionCb = (...m) => {
            e.mediaInteaction && e.mediaInteaction(...m),
            l(...m)
        }
        ,
        t.styleSheetRuleCb = (...m) => {
            e.styleSheetRule && e.styleSheetRule(...m),
            c(...m)
        }
        ,
        t.styleDeclarationCb = (...m) => {
            e.styleDeclaration && e.styleDeclaration(...m),
            u(...m)
        }
        ,
        t.canvasMutationCb = (...m) => {
            e.canvasMutation && e.canvasMutation(...m),
            d(...m)
        }
        ,
        t.fontCb = (...m) => {
    ...
    function Xr(t, e={}) {
        ...
        for (const S of t.plugins)
            b.push(S.observer(S.callback, n, S.options));
        return () => {
    ...
    class Zr {
        ...
        transformCrossOriginEvent(e, n) {
            ...
            switch (n.type) {
            case C.FullSnapshot:
                return this.crossOriginIframeMirror.reset(e),
        ...
        replace(e, n, r, o) {
            for (const a of o)
                !Array.isArray(n[a]) && typeof n[a] != "number" || (Array.isArray(n[a]) ? n[a] = e.getIds(r, n[a]) : n[a] = e.getId(r, n[a]));
            return n
        }
        replaceIds(e, n, r) {
    ...
    var Kr = Object.defineProperty
      ...
      , un = (t, e) => {
        for (var n in e || (e = {}))
            qr.call(e, n) && cn(t, n, e[n]);
        if (ln)
            for (var n of ln(e))
                eo.call(e, n) && cn(t, n, e[n]);
        return t
    }
      , dn = (t, e) => Qr(t, Jr(e));
    class to {
        ...
        addShadowRoot(e, n) {
            !Le(e) || this.shadowDoms.has(e) || (this.shadowDoms.add(e),
            tn(dn(un({}, this.bypassOptions), {
                doc: n,
                mutationCb: this.mutationCb,
                mirror: this.mirror,
                shadowDomManager: this
            }), e),
            nn(dn(un({}, this.bypassOptions), {
    ...
    for (var Me = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", We = typeof Uint8Array > "u" ? [] : new Uint8Array(256), He = 0; He < Me.length; He++)
    ...
    function yn(t, e, n) {
        ...
        try {
            const o = ge(t.HTMLCanvasElement.prototype, "getContext", function(a) {
                return function(s, ...i) {
                    return Q(this, e, n, !0) || "__context"in this || (this.__context = s),
                    a.apply(this, [s, ...i])
                }
            });
            r.push(o)
    ...
    function io(t, e, n, r, o) {
        const a = [];
        return a.push(...gn(e.WebGLRenderingContext.prototype, pe.WebGL, t, n, r, o, e)),
...
`, 10) + 1
    ...
    var uo = co("", null, !1)
      ...
      , mo = (t, e) => {
        var n = {};
        for (var r in t)
            ho.call(t, r) && e.indexOf(r) < 0 && (n[r] = t[r]);
        if (t != null && vn)
            for (var r of vn(t))
                e.indexOf(r) < 0 && po.call(t, r) && (n[r] = t[r]);
        return n
    }
    ...
    class yo {
        constructor(e) {
            ...
            s && typeof n == "number" && this.initCanvasFPSObserver(n, r, o, a, {
                dataURLOptions: i
            })
        }
        reset() {
        ...
        initCanvasFPSObserver(e, n, r, o, a) {
            ...
            const h = () => {
              ...
              , p = m => {
                ...
                u = m,
                h().forEach(b => fo(this, null, function*() {
                    var S;
    ...
    var vo = Object.defineProperty
      ...
      , se = (t, e) => {
        for (var n in e || (e = {}))
            wo.call(e, n) && bn(t, n, e[n]);
        if (Sn)
            for (var n of Sn(e))
                Eo.call(e, n) && bn(t, n, e[n]);
        return t
    }
      , No = (t, e) => So(t, bo(e));
    function G(t) {
    ...
    function be(t={}) {
        ...
        g !== void 0 && f.mousemove === void 0 && (f.mousemove = g),
        le.reset();
        const $ = u === !0 ? {
            color: !0,
            date: !0,
        ...
        const te = I => {
            for (const oe of J || [])
                oe.eventProcessor && (I = oe.eventProcessor(I));
            return S && (I = S(I)),
            I
        }
        ;
        V = (I, oe) => {
            var ae;
            if (((ae = Se[0]) == null ? void 0 : ae.isFrozen()) && I.type !== C.FullSnapshot && !(I.type === C.IncrementalSnapshot && I.data.source === N.Mutation) && Se.forEach(B => B.unfreeze()),
            z)
                e?.(te(I), oe);
            else if (X) {
                const B = {
            ...
            if (I.type === C.FullSnapshot)
                H = I,
                L = 0;
            else if (I.type === C.IncrementalSnapshot) {
                if (I.data.source === N.Mutation && I.data.isAttachIframe)
                    return;
                L++;
                const B = r && L >= r
        ...
        Xe = (I=!1) => {
            ...
            const Ue = Sr(document, {
                ...
                ,
                onIframeLoad: (re, It) => {
                    ne.attachIframe(re, It),
                    xe.observeAttachShadow(re)
                }
                ,
    ...
    function xo(t) {
        return class Zn extends t {
            ...
            insertBefore(n, r) {
                ...
                return this.childNodes.splice(a, 0, n),
            ...
            removeChild(n) {
                ...
                return this.childNodes.splice(r, 1),
                n.parentElement = null,
                n.parentNode = null,
                n
            }
            ...
            write(n) {
                let r;
                if (n === '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "">' ? r = "-//W3C//DTD XHTML 1.0 Transitional//EN" : n === '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "">' && (r = "-//W3C//DTD HTML 4.0 Transitional//EN"),
                r) {
    ...
    function Nn(t) {
        return class extends t {
            ...
            get textContent() {
                let e = "";
                return this.childNodes.forEach(n => e += n.textContent),
                e
            }
            set textContent(e) {
            ...
            insertBefore(e, n) {
                ...
                if (r == -1)
                    throw new Error("Failed to execute 'insertBefore' on 'RRNode': The RRNode before which the new node is to be inserted is not a child of this RRNode.");
                return this.childNodes.splice(r, 0, e),
                e.parentElement = this,
                e.parentNode = this,
                e
            }
    ...
    function _o(t, e, n) {
        ...
        for (const a in o) {
            const s = o[a]
              , i = n.getMeta(e);
            if (i && "isSVG"in i && i.isSVG && yt[a])
                t.setAttributeNS(yt[a], a, s);
        ...
        for (const {name: a} of Array.from(r))
            a in o || t.removeAttribute(a);
        ...
        for (; s <= i && l <= c; ) {
            ...
            if (u === void 0)
                ...
                b) {
                    ...
                    n.nodeName === "#document" && ((a = r.mirror.getMeta(E)) === null || a === void 0 ? void 0 : a.type) === R.Element && n.documentElement && (n.removeChild(n.documentElement),
                    t[s] = void 0,
                    u = void 0),
    ...
    function gt(t, e, n) {
        ...
        case R.Element:
            {
                ...
                s = Ao[s] || s,
                o && "isSVG"in o && o?.isSVG ? a = document.createElementNS(yt.svg, s) : a = document.createElement(t.tagName);
                break
            }
        case R.Text:
        ...
        return o && e.add(a, Object.assign({}, o)),
        a
    }
    ...
    function kn(t, e, n, r) {
        ...
        case U.DOCUMENT_NODE:
            r && r.nodeName === "IFRAME" ? o = r.contentDocument : (o = e,
            o.compatMode = t.compatMode);
            break;
        ...
        let a = n.getMeta(t);
        return e instanceof ke && (a || (a = Dn(o, e.unserializedId),
        n.add(t, a)),
    ...
    function zo(t, e=Io(), n=new ke) {
        function r(o, a) {
            const s = kn(o, n, e, a);
            if (s !== null)
                if (a?.nodeName !== "IFRAME" && o.nodeType !== U.DOCUMENT_FRAGMENT_NODE && (a?.appendChild(s),
                s.parentNode = a,
                s.parentElement = a),
                o.nodeName === "IFRAME") {
                    ...
                    (o.nodeType === U.DOCUMENT_NODE || o.nodeType === U.ELEMENT_NODE || o.nodeType === U.DOCUMENT_FRAGMENT_NODE) && (o.nodeType === U.ELEMENT_NODE && o.shadowRoot && r(o.shadowRoot, s),
    ...
    function Zo(t=window, e=document) {
        ...
        function d(f, y) {
            if (y === "Y")
                return f.clientHeight + i < f.scrollHeight;
            if (y === "X")
                return f.clientWidth + i < f.scrollWidth
        }
        function h(f, y) {
        ...
        n.prototype.scrollIntoView = function() {
            ...
            f !== e.body ? (S.call(this, f, f.scrollLeft + g.left - y.left, f.scrollTop + g.top - y.top),
            t.getComputedStyle(f).position !== "fixed" && t.scrollBy({
                left: y.left,
                top: y.top,
                behavior: "smooth"
            })) : t.scrollBy({
    ...
    class Ko {
        ...
        start() {
            ...
            const n = () => {
                ...
                for (this.timeOffset += (r - e) * this.speed,
                e = r; this.actions.length; ) {
        ...
        findActionIndex(e) {
            ...
            for (; n <= r; ) {
                ...
                if (this.actions[o].delay < e.delay)
                    n = o + 1;
                else if (this.actions[o].delay > e.delay)
                    r = o - 1;
                else
                    return o + 1
            }
    ...
    ***************************************************************************** */
    ...
    function Un(t) {
        var e = t.initialState
          ...
          , o = {
            _machine: t,
            send: function(a) {
                n === De.Running && (e = t.transition(e, a),
                $n(e, _n(a)),
    ...
    var Qo = Object.defineProperty
      ...
      , St = (t, e) => {
        for (var n in e || (e = {}))
            es.call(e, n) && Bn(t, n, e[n]);
        if (Vn)
            for (var n of Vn(e))
                ts.call(e, n) && Bn(t, n, e[n]);
        return t
    }
      , bt = (t, e) => Jo(t, qo(e));
    function ns(t, e) {
        for (let n = t.length - 1; n >= 0; n--) {
            const r = t[n];
            if (r.type === C.Meta && r.timestamp <= e)
                return t.slice(n)
        }
        return t
    }
        ...
        const o = Wn({
            ...
            actions: {
                ...
                recordTimeOffset: Re( (a, s) => {
                    let i = a.timeOffset;
                    return "payload"in s && "timeOffset"in s.payload && (i = s.payload.timeOffset),
                    bt(St({}, a), {
                        timeOffset: i,
                ...
                play(a) {
                    ...
                    const d = ns(l, c);
                    let h = u?.timestamp;
                    u?.type === C.IncrementalSnapshot && u.data.source === N.MouseMove && (h = u.timestamp + ((s = u.data.positions[0]) == null ? void 0 : s.timeOffset)),
                ...
                startLive: Re({
                    baselineTime: (a, s) => (a.timer.toggleLiveMode(!0),
                    a.timer.start(),
                    s.type === "TO_LIVE" && s.payload.baselineTime ? s.payload.baselineTime : Date.now())
                }),
                addEvent: Re( (a, s) => {
    ...
    function ye(t, e, n) {
        return r => is(this, null, function*() {
            if (r && typeof r == "object" && "rr_type"in r)
                ...
                return yield Promise.all(r.map(ye(t, e, n)));
            return r
        })
    }
    ...
    var fs = Object.defineProperty
      ...
      , Qe = (t, e) => {
        for (var n in e || (e = {}))
            vs.call(e, n) && Yn(t, n, e[n]);
        if (Hn)
            for (var n of Hn(e))
                Ss.call(e, n) && Yn(t, n, e[n]);
        return t
    }
      , wt = (t, e) => ys(t, gs(e))
      , Et = (t, e, n) => new Promise( (r, o) => {
        var a = l => {
            try {
                i(n.next(l))
            } catch (c) {
    ...
    class Ns {
        constructor(e, n) {
            ...
            this.handleResize = i => {
                ...
                for (const l of [this.mouseTail, this.iframe])
                    !l || (l.setAttribute("width", String(i.width)),
            ...
            this.applyEventsSynchronously = i => {
                ...
                this.touchActive === !0 ? this.mouse.classList.add("touch-active") : this.touchActive === !1 && this.mouse.classList.remove("touch-active"),
                this.touchActive = null
            }
            ,
            this.getCastFn = (i, l=!1) => {
                ...
                case C.FullSnapshot:
                    c = () => {
                        ...
                        (u = this.iframe.contentWindow) == null || u.scrollTo(i.data.initialOffset),
                        this.styleMirror.reset()
                    }
                    ;
                    break;
                case C.IncrementalSnapshot:
                    c = () => {
                        if (this.applyIncremental(i, l),
                        !l && (i === this.nextUserInteractionEvent && (this.nextUserInteractionEvent = null,
                        this.backToNormal()),
                        this.config.skipInactive && !this.nextUserInteractionEvent)) {
                            ...
                            if (this.nextUserInteractionEvent) {
                                const u = this.nextUserInteractionEvent.delay - i.delay
                                  , d = {
                                    speed: Math.min(Math.round(u / ws), this.config.maxSpeed)
                                };
                ...
                return () => {
                    ...
                    if (i === this.service.state.context.events[u]) {
                        const d = () => {
                            u < this.service.state.context.events.length - 1 || (this.backToNormal(),
            ...
            this.emitter.on(O.Flush, () => {
                if (this.usingVirtualDom) {
                    ...
                    if (this.iframe.contentDocument && de(this.iframe.contentDocument, this.virtualDom, i, this.virtualDom.mirror),
                    ...
                    Object.keys(this.legacy_missingNodeRetryMap).length)
                        for (const l in this.legacy_missingNodeRetryMap)
                            try {
                                ...
                                de(u, c.node, i, this.virtualDom.mirror),
                                c.node = u
                            } catch (c) {
                ...
                this.mousePos = null),
                this.lastSelectionData && (this.applySelection(this.lastSelectionData),
                this.lastSelectionData = null)
            }
            ),
            ...
            s && setTimeout( () => {
                var i;
                this.firstFullSnapshot || (this.firstFullSnapshot = s,
                this.rebuildFullSnapshot(s),
                (i = this.iframe.contentWindow) == null || i.scrollTo(s.data.initialOffset))
            }
            , 1),
        ...
        setConfig(e) {
            ...
            typeof e.speed < "u" && this.speedService.send({
                type: "SET_SPEED",
                payload: {
                    speed: e.speed
                }
            }),
            typeof e.mouseTail < "u" && (e.mouseTail === !1 ? this.mouseTail && (this.mouseTail.style.display = "none") : (this.mouseTail || (this.mouseTail = document.createElement("canvas"),
        ...
        addEvent(e) {
            ...
            Promise.resolve().then( () => this.service.send({
                type: "ADD_EVENT",
                payload: {
                    event: n
                }
        ...
        setupDom() {
            ...
            this.config.mouseTail !== !1 && (this.mouseTail = document.createElement("canvas"),
            this.mouseTail.classList.add("replayer-mouse-tail"),
            this.mouseTail.style.display = "inherit",
            ...
            this.iframe.contentWindow && this.iframe.contentDocument && (Zo(this.iframe.contentWindow, this.iframe.contentDocument),
            at(this.iframe.contentWindow))
        }
        rebuildFullSnapshot(e, n=!1) {
            if (!this.iframe.contentDocument)
                return console.warn("Looks like your replayer has been destroyed.");
            Object.keys(this.legacy_missingNodeRetryMap).length && console.warn("Found unresolved missing node map", this.legacy_missingNodeRetryMap),
            this.legacy_missingNodeRetryMap = {};
            const r = []
              , o = (i, l) => {
                this.collectIframeAndAttachDocument(r, i);
                for (const c of this.config.plugins || [])
                    c.onBuild && c.onBuild(i, {
                        id: l,
                        replayer: this
                    })
            }
            ...
            for (const {mutationInQueue: i, builtNode: l} of r)
                ...
                this.newDocumentQueue = this.newDocumentQueue.filter(c => c !== i);
        ...
        insertStyleRules(e, n) {
            ...
            if (this.config.pauseAnimation && o.push("html.rrweb-paused *, html.rrweb-paused *:before, html.rrweb-paused *:after { animation-play-state: paused !important; }"),
        ...
        attachDocumentToIframe(e, n) {
            ...
            for (const {mutationInQueue: s, builtNode: i} of o)
                ...
                this.newDocumentQueue = this.newDocumentQueue.filter(l => l !== s)
        }
        ...
        waitForStylesheetLoad() {
            ...
            if (n) {
                ...
                ;
                this.emitter.on(O.Start, s),
                this.emitter.on(O.Pause, s);
                const i = () => {
                    this.emitter.off(O.Start, s),
                    this.emitter.off(O.Pause, s)
                }
                ;
                n.querySelectorAll('link[rel="stylesheet"]').forEach(l => {
                    ...
                    l.addEventListener("load", () => {
                        r.delete(l),
                        r.size === 0 && o !== -1 && (a.matches("playing") && this.play(this.getCurrentTime()),
        ...
        preloadAllImages() {
            return Et(this, null, function*() {
                ...
                ;
                this.emitter.on(O.Start, e),
                this.emitter.on(O.Pause, e);
                const n = [];
                for (const r of this.service.state.context.events)
                    r.type === C.IncrementalSnapshot && r.data.source === N.CanvasMutation && (n.push(this.deserializeAndPreloadCanvasEvents(r.data, r)),
            ...
            case N.MouseInteraction:
                {
                    ...
                    case j.TouchStart:
                    case j.TouchEnd:
                        n ? (s.type === j.TouchStart ? this.touchActive = !0 : s.type === j.TouchEnd && (this.touchActive = !1),
                        this.mousePos = {
                            x: s.x,
                            y: s.y,
                            id: s.id,
                        ...
                        s.type === j.Click ? (this.mouse.classList.remove("active"),
                        this.mouse.offsetWidth,
                        this.mouse.classList.add("active")) : s.type === j.TouchStart ? (this.mouse.offsetWidth,
                        this.mouse.classList.add("touch-active")) : s.type === j.TouchEnd && this.mouse.classList.remove("touch-active"));
                        break;
                    case j.TouchCancel:
        ...
        applyMutation(e, n) {
            if (this.config.useVirtualDom && !this.usingVirtualDom && n && (this.usingVirtualDom = !0,
            ...
            e.removes.forEach(c => {
                ...
                if (!d)
                    return e.removes.find(p => p.id === c.parentId) ? void 0 : this.warnNodeNotFound(e, c.id);
                let h = r.getNode(c.parentId);
                if (!h)
                    return this.warnNodeNotFound(e, c.parentId);
                if (c.isShadow && ve(h) && (h = h.shadowRoot),
                r.removeNodeFromMap(d),
                h)
                    try {
                        h.removeChild(d),
                        this.usingVirtualDom && d.nodeName === "#text" && h.nodeName === "STYLE" && ((u = h.rules) == null ? void 0 : u.length) > 0 && (h.rules = [])
                    } catch (p) {
            ...
            const o = Qe({}, this.legacy_missingNodeRetryMap)
              ...
              , s = c => {
                let u = null;
                return c.nextId && (u = r.getNode(c.nextId)),
              ...
              , i = c => {
                ...
                if (!d)
                    return c.node.type === D.Document ? this.newDocumentQueue.push(c) : a.push(c);
                ...
                let h = null
                  , p = null;
                if (c.previousId && (h = r.getNode(c.previousId)),
                c.nextId && (p = r.getNode(c.nextId)),
                s(c))
                    return a.push(c);
                if (c.node.rootId && !r.getNode(c.node.rootId))
                    return;
                ...
                if (f && f.type === D.Element && f.tagName === "textarea" && c.node.type === D.Text) {
                    ...
                    for (const g of y)
                        g.nodeType === d.TEXT_NODE && d.removeChild(g)
                }
                ...
                if (b(S, c.node.id),
                this.usingVirtualDom && S.nodeName === "#text" && d.nodeName === "STYLE" && ((u = d.rules) == null ? void 0 : u.length) > 0 && (d.rules = []),
                Ie(S, this.mirror)) {
                    const y = this.mirror.getId(S)
                      , g = this.newDocumentQueue.find(E => E.parentId === y);
                    g && (this.attachDocumentToIframe(g, S),
                    this.newDocumentQueue = this.newDocumentQueue.filter(E => E !== g))
                }
            ...
            for (; a.length; ) {
                ...
                for (const u of c)
                    r.getNode(u.value.parentId) ? lt(u, d => {
                        i(d)
                    }
            ...
            Vt(e.texts).forEach(c => {
                ...
                const d = r.getNode(c.id);
                if (!d)
                    return e.removes.find(h => h.id === c.id) ? void 0 : this.warnNodeNotFound(e, c.id);
                if (d.textContent = c.value,
                this.usingVirtualDom) {
            ...
            e.attributes.forEach(c => {
                ...
                if (!u)
                    return e.removes.find(d => d.id === c.id) ? void 0 : this.warnNodeNotFound(e, c.id);
        ...
        applyScroll(e, n) {
            ...
            if (a === this.iframe.contentDocument)
                (r = this.iframe.contentWindow) == null || r.scrollTo({
                    top: e.y,
                    left: e.x,
                    behavior: n ? "auto" : "smooth"
                });
            else if (s?.type === D.Document)
                (o = a.defaultView) == null || o.scrollTo({
                    top: e.y,
                    left: e.x,
                    behavior: n ? "auto" : "smooth"
                });
        ...
        applyStyleDeclaration(e, n) {
            e.set && Te(n.rules, e.index).style.setProperty(e.set.property, e.set.value, e.set.priority),
            e.remove && Te(n.rules, e.index).style.removeProperty(e.remove.property)
        }
        applyAdoptedStyleSheet(e) {
            ...
            (n = e.styles) == null || n.forEach(i => {
                ...
                let c = null
                  , u = null;
                if (ve(r) ? u = ((l = r.ownerDocument) == null ? void 0 : l.defaultView) || null : r.nodeName === "#document" && (u = r.defaultView),
                !!u)
                    try {
            ...
            const s = (i, l) => {
                ...
                ve(i) ? i.shadowRoot.adoptedStyleSheets = c : i.nodeName === "#document" && (i.adoptedStyleSheets = c),
                c.length !== l.length && a < o && (setTimeout( () => s(i, l), 0 + 100 * a),
                a++)
            }
            ;
            s(r, e.styleIds)
        ...
        legacy_resolveMissingNode(e, n, r, o) {
            ...
            if (i) {
                ...
                (u.previousId || u.nextId) && this.legacy_resolveMissingNode(e, n, c, u)
            }
            if (l) {
        ...
        moveAndHover(e, n, r, o, a) {
            ...
            if (!s)
                return this.debugNodeNotFound(a, r);
        ...
        drawMouseTail(e) {
            ...
            const {lineCap: n, lineWidth: r, strokeStyle: o, duration: a} = this.config.mouseTail === !0 ? Ct : Object.assign({}, Ct, this.config.mouseTail)
              , s = () => {
                ...
                !i || !this.tailPositions.length || (i.clearRect(0, 0, this.mouseTail.width, this.mouseTail.height),
                i.beginPath(),
                i.lineWidth = r,
                i.lineCap = n,
                i.strokeStyle = o,
            ...
            s(),
            setTimeout( () => {
                this.tailPositions = this.tailPositions.filter(i => i !== e),
                s()
            }
        ...
        backToNormal() {
            ...
            !this.speedService.state.matches("normal") && (this.speedService.send({
                type: "BACK_TO_NORMAL"
            }),
